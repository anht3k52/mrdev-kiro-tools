#!/usr/bin/env bash
# Build Tool 3 — 9router Injector (Linux binary)
...
echo "=== Build Linux binary (Nuitka) — Tool 3 9router Injector ==="
...
chmod +x "_build/Tool3_9router_Injector"
echo ""
echo "=== Done: _build/Tool3_9router_Injector ==="
